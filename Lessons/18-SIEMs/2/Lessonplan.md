## 18.2 Lesson Plan: Splunk Searches
...
The time tracker is available on Google Drive here: [18.2 Time Tracker](https://docs.google.com/spreadsheets/d/1s8kn55fCADkgBwufWI3vsHrHisZpglwA5fEHMBjaON0/edit#gid=1145703143)
...
- [18.2 Student Guide](studentguide.md)
...
Explain that for the next two units we will focus on one of the most popular SIEM vendors, Splunk.
...
- You will continue to play the role of a recently-hired SOC manager at Omni Military Products (OMP).
